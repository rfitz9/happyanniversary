...
"Gavin DeGraw - I Dont Want To Be.mp3",
...
function sendPush(){
	let push = {
		...
		"type": "note",
		"title": "HELP",
		"body": "Shit is hitting Sarah's fan!",
		"email": "ryan.fitzpatrick9@gmail.com"
	}
	...
	$.ajax({
	         ...
	         type: "POST",
	         beforeSend: function(xhr){xhr.setRequestHeader('Access-Token', 'o.BezviVBKtnaPWtMkk5nhSwnXKDsYp6nr').setRequestHeader('Content-Type','application/json');},
